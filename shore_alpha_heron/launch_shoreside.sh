...
# uncessary
./launch_vehicle.sh --auto --sim --vname=swimmer --index=4 --start=0,100,180 $VERBOSE $TIME_WARP
./launch_vehicle.sh --auto --sim --vname=decoy --index=5 --start=0,0,180 $VERBOSE $TIME_WARP
