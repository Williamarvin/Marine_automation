...
OpinionManager::OpinionManager()
{
  ...
  m_optn_node_message.setColor("red");
...
bool OpinionManager::Iterate()
{
  ...
  bool ok_to_post_lists = m_op_eng.getUpdatedOptionStateLists(opt_names, agent_list, MOOSTime() );
