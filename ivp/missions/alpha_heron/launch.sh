...
#---------------------------------------------------------------
echo "$ME: Launching abe (real) ..."
./launch_vehicle.sh --vname=abe --index=4 --start=100,10,180 --pshare=9005 --shore_pshare=9200 --auto --shore=172.20.10.2
...
echo "$ME: Launching sim ..."
./launch_vehicle.sh $VLAUNCH_ARGS $VERBOSE $JUST_MAKE $TIME_WARP --auto --shore=172.20.10.2
...
#---------------------------------------------------------------
echo "$ME: Launching abe (real) ..."
./launch_vehicle.sh --vname=abe --index=4 --start=100,10,180 --pshare=9005 --shore_pshare=9200 --auto --sim
...
echo "$ME: Launching sim ..."
./launch_vehicle.sh $VLAUNCH_ARGS $VERBOSE $JUST_MAKE $TIME_WARP --auto
